...
export const tools = [
  {
    ...
    logo: terraform,
    tags: ['iac'],
    note: 'Infrastructure as Code across cloud and on-premise estates — reusable modules published to a private registry, gated by module tests and Sentinel policies.',
  },
  {
    name: 'Ansible',
    logo: ansible,
  ...
  },
  {
    ...
    logo: kubernetes,
    tags: ['delivery'],
    note: 'Service delivery on AKS — authoring Helm charts and manifests, deploying and configuring clusters, and handling ingress, networking and production debugging.',
  },
  {
    name: 'Docker',
    logo: docker,
    tags: ['delivery'],
    note: 'Dockerfiles behind services, and the build pipelines that tag, scan for vulnerabilities, test and push each image to the registry.',
  },
  {
    name: 'Azure DevOps',
    logo: azureDevops,
    tags: ['delivery'],
    note: 'Building and operating the release pipelines services ship through, alongside organization access, repositories and the self-hosted agent pools behind them.',
  },
  {
    name: 'Azure',
    logo: azure,
    tags: ['cloud'],
    note: 'Provisioning, configuring and managing infrastructure across the Azure platform, from core networking through to managed data and application services.',
  },
  {
    name: 'AWS',
    logo: aws,
  ...
  },
  {
    ...
    logo: vmware,
    tags: ['cloud'],
    note: 'Provisioning virtualized environments programmatically and operating vSphere end to end, from host and datastore administration through to the NSX networking and Pure Storage underneath.',
  },
  {
    name: 'Python',
    logo: python,
    tags: ['scripting'],
    note: 'REST APIs, database layers, GUIs and automation tooling, including concurrent workloads where serial execution does not scale.',
  },
  {
    name: 'PowerShell',
    logo: powershell,
    tags: ['scripting'],
    note: 'Windows system administration and vSphere configuration through PowerCLI, plus the OpenVPN client installer packaged as a compiled executable.',
  },
];
