...
export const tools = [
  ...
  },
  {
    ...
    logo: aws,
    tags: ['cloud'],
    note: 'I automate EC2 provisioning and management through internal tooling, covering instance templates, networking and security configuration, alongside cost management across the estate.',
  },
  {
    name: 'VMware',
    logo: vmware,
