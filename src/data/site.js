...
export const tools = [
  {
    ...
    logo: terraform,
    tags: ['iac'],
    note: 'I write and publish the modules behind our cloud environments — web services, on-premise VMs, load balancer configuration — to a private registry, gated by module tests and Sentinel policies.',
  },
  {
    name: 'Ansible',
    logo: ansible,
    tags: ['iac'],
    note: 'I\'ve rolled domain-joining across production Linux fleets, and configured the security tooling, web servers and management servers that new client environments are built on.',
  },
  {
    name: 'Kubernetes',
    logo: kubernetes,
    tags: ['delivery'],
    note: 'I author the Helm charts and service definitions, deploy the AKS infrastructure beneath them, and diagnose production incidents on the clusters running them.',
  },
  {
    name: 'Docker',
    logo: docker,
    tags: ['delivery'],
    note: 'I write the Dockerfiles and the services inside them, and own the pipeline that builds, scans, tests and ships every image.',
  },
  {
    name: 'Azure DevOps',
    logo: azureDevops,
    tags: ['delivery'],
    note: 'I build, run and debug the release pipelines, administer organization access and repositories, and configure the self-hosted agent pools they run on.',
  },
  {
    name: 'Azure',
    logo: azure,
    tags: ['cloud'],
    note: 'My primary cloud, in advanced daily use: application gateways, virtual networks, Key Vault, SQL Server, storage accounts, Functions, Service Bus and private DNS — deployed, configured and operated.',
  },
  {
    name: 'AWS',
    logo: aws,
    tags: ['cloud'],
    note: 'I\'ve programmatically provisioned EC2 fleets through a Boto3 wrapper I wrote — security groups, launch templates, Elastic IP associations and health checks — alongside cost management across the estate.',
  },
  {
    name: 'VMware',
    logo: vmware,
    tags: ['cloud'],
    note: 'I\'ve deployed 40+ VM environments programmatically and operate the estate end to end: hosts, datastores and guests, plus the NSX networking and Pure Storage behind them.',
  },
  {
    name: 'Python',
    logo: python,
    tags: ['scripting'],
    note: 'Five years across APIs, database tooling, GUIs and automation — including the fleet health check I rewrote from a full-day run down to roughly an hour.',
  },
  {
    name: 'PowerShell',
    logo: powershell,
    tags: ['scripting'],
    note: 'My primary tool for Windows estate management and VMware configuration, and what the OpenVPN client program was written in.',
  },
];
